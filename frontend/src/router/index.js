...
const portalRoutes = [
  ...
  { path: '/portal/vehicle/calendar', name: 'CleverPortalVehicleCalendar', component: () => import('@/views/FleetManagementView.vue'), meta: { requiresAuth: true, adminOnly: true, fleetTab: 'calendar' } },
